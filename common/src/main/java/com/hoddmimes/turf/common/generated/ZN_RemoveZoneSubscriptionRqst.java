...
import com.google.gson.GsonBuilder;
            ...
            {
                public static String NAME = "ZN_RemoveZoneSubscriptionRqst";
        ...
        public static  Builder getZN_RemoveZoneSubscriptionRqstBuilder() {
            return new ZN_RemoveZoneSubscriptionRqst.Builder();
        }


        public static class  Builder {
          private ZN_RemoveZoneSubscriptionRqst mInstance;

          private Builder () {
            mInstance = new ZN_RemoveZoneSubscriptionRqst();
          }
        ...
        public ZN_RemoveZoneSubscriptionRqst build() {
            return mInstance;
        }
