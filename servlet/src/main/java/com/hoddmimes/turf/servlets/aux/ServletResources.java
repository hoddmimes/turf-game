...
import com.hoddmimes.turf.servlets.ServletResourcesIf;
...
public class ServletResources extends HttpServlet implements ServletResourcesIf
{
    ...
    private Logger mLogger = LogManager.getLogger( ServletResources.class );
    ...
    public void init(ServletConfig pConfig) throws ServletException {
        ...
        try {
            ...
            mLogger.info("Successfully connected to turf server \"" + tHost + "\" on port " + tPort );
        }
        catch (Exception e ) {
        ...
        mLogger.info(" Starting Turf Servlet Engine ");
    }
        ...
        public void run() {
            if (mTcpClientTest == null) {
                try {
                    ...
                    mLogger.debug("successfully connected to test system \"" + mHost + "\"  on port " + mPort);
                }
                catch (Exception e ) {
                    mLogger.debug("Failed to connect to test system \"" + mHost + "\" on port " + mPort + " reason: " + e.getMessage());
                    mTcpClientTest = null;
                }
