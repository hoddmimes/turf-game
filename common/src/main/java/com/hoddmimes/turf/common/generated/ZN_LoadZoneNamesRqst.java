...
import com.google.gson.GsonBuilder;
            ...
            {
                public static String NAME = "ZN_LoadZoneNamesRqst";
        ...
        public static  Builder getZN_LoadZoneNamesRqstBuilder() {
            return new ZN_LoadZoneNamesRqst.Builder();
        }


        public static class  Builder {
          private ZN_LoadZoneNamesRqst mInstance;

          private Builder () {
            mInstance = new ZN_LoadZoneNamesRqst();
          }

        

        public ZN_LoadZoneNamesRqst build() {
            return mInstance;
        }
